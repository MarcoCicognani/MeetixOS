...
public:
	 ...
	 * filled constructor
	 */
	Insets(int32_t top, int32_t left, int32_t bottom, int32_t right) : top(top), left(left), bottom(bottom), right(right) {}
	 ...
	 */
	bool operator==(const Insets &rhs) const { return top == rhs.top && left == rhs.left && bottom == rhs.bottom && right == rhs.right; }
