...
public:
	 ...
	 * filled constructor
	 */
	Range(int32_t _a, int32_t _b) { set(_a, _b); }
	 ...
	 */
	int32_t getFirst() { return first; }

	/**
	 * return the end of range
	 */
	int32_t getLast() { return last; }

	/**
	 * return the range length
	 */
	int32_t getLength() { return last - first; }
	 ...
	 */
	bool operator==(const Range &p) const { return (first == p.first) && (last == p.last); }
