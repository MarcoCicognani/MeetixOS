...
public:
	// constructors
	ButtonList() {}
	ButtonList(const std::string &name, Button *button, const std::function<void(void)> &handler) { add(name, button, handler); }
	...
	void configure(const std::string &name, const Rectangle &bounds, const std::string &title, Color_t buttonColor, Color_t titleColor);
	void configure(const std::string &name, const Rectangle &bounds, const std::string &title, const std::string &pathToPng, const Point &pngPosition);
	void configure(const std::string &name, const Rectangle &bounds, const std::string &title, const std::string &pathToPng, const Point &pngPosition, Color_t buttonColor, Color_t titleColor);
