...
protected:
	 ...
	 *
	 */
	Canvas(uint32_t id) : graphics(0), Component(id, UI_COMPONENT_TYPE_CANVAS), currentBuffer(0), nextBuffer(0), userListener(0) {}
...
public:
	 ...
	 *
	 */
	void setBufferListener(CanvasBufferListener *l) { userListener = l; }
};
