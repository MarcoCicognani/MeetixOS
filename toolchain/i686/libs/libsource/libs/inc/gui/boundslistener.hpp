...
#ifndef MEETIX_LIBRARY_UI_BOUNDSLISTENER
#define MEETIX_LIBRARY_UI_BOUNDSLISTENER
...
{
public:
	virtual ~BoundsListener() {}

	virtual void process(UiComponentEventHeader *header)
	{

		UiComponentBoundsEvent *boundsEvent = (UiComponentBoundsEvent*) header;
