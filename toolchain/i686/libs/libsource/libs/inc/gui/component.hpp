...
protected:
	 ...
	 *
	 */
	Component(UiComponentID id, UiComponentType tp) : id(id), type(tp), BoundsEventComponent(this, id) {}

	/**
	 *
	 */
	template<typename ComponentType> struct Concrete : ComponentType
	{
	 ...
	 *
	 */
	template<typename ComponentType, UiComponentType ComponentConstant> static ComponentType *createComponent()
	{
		if (!UiInitialized) return 0;
...
public:
	 ...
	 *
	 */
	inline UiComponentID getID() { return id; }
};
