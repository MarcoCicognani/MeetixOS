 ...
 */
Font_t::Font_t(const std::string &name, uint8_t *source, uint32_t sourceLength, FontStyle style, bool hint) : name(name), data(nullptr), face(0), okay(false), style(style), activeSize(0), hint(hint)
{
