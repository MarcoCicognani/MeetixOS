...
public:
	...
	bool runTermCommand(string command, File_t *termIn, File_t *termOut, File_t *termErr, Pid *intPid);
	...
	string readInput(string there, Screen *screen, ShellInputStatus *outStatus, bool *continueInput, bool visible = true);
