...
public:
	...
	virtual void setColorForeground(int c) { colorForeground = c; }
	virtual void setColorBackground(int c) { colorBackground = c; }

	virtual int getColorForeground() { return colorForeground; }
	virtual int getColorBackground() { return colorBackground; }

	virtual int getWidth() = 0;
	virtual int getHeight() = 0;

	virtual void lock() { AtomicLock(&_lock); }
	virtual void unlock() { _lock = false; }
