...
Rectangle Scrollbar_t::calculateKnob()
{
	...
	if (orientation == ScrollbarOrientation_t::VERTICAL) return Rectangle(0, viewPosition, bounds.width, knobSize);

	else if (orientation == ScrollbarOrientation_t::HORIZONTAL) return Rectangle(viewPosition, 0, knobSize, bounds.height);
...
int Scrollbar_t::getViewMax()
{
	...
	if (orientation == ScrollbarOrientation_t::VERTICAL) return getBounds().height - getKnobSize();

	else if (orientation == ScrollbarOrientation_t::HORIZONTAL) return getBounds().width - getKnobSize();
...
int Scrollbar_t::getKnobSize()
{
	...
	int bounds;
	if (orientation == ScrollbarOrientation_t::VERTICAL) bounds = getBounds().height;

	else if (orientation == ScrollbarOrientation_t::HORIZONTAL) bounds = getBounds().width;
