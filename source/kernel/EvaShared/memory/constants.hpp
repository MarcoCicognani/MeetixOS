...
#define CONST_SMP_STARTUP_AREA_PAGE_DIRECTORY				0x00000500 // initial page directory address is put here
...
#define CONST_RECURSIVE_PAGE_TABLE(ti)						(((PageTable) CONST_RECURSIVE_PAGE_DIRECTORY_AREA) + (0x400 * ti)) // note the pointer arithmetics.
