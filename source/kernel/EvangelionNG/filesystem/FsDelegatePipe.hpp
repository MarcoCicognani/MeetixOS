...
#ifndef EVA_FILESYSTEM_FILESYSTEMRAMDISKPIPE
#define EVA_FILESYSTEM_FILESYSTEMRAMDISKPIPE
 ...
 *
 */
class FsDelegatePipe : public FsDelegate
{
public:
	/**
	 *
	 */
	virtual ~FsDelegatePipe()
	{
	}
	 ...
	 *
	 */
	virtual FsTransactionID requestDirectoryRefresh(Thread *requester, FsNode *node, FsTransactionHandlerDirectoryRefresh *handler);
