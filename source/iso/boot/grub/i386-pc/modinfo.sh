...
# Build environment
grub_target_cc='i686-ghost-gcc'
grub_target_cc_version=''
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /ghost/lib/gcc/i686-ghost/4.9.1/include'
grub_target_ccasflags=' -g -m32'
grub_target_ldflags=' -m32 -Wl,-melf_i386 -Wl,--build-id=none'
grub_target_strip='i686-ghost-strip'
grub_target_nm='i686-ghost-nm'
grub_target_ranlib='i686-ghost-ranlib'
grub_target_objconf=''
grub_target_obj2elf=''
