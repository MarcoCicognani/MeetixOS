...
template<typename T> constexpr bool IsNullPtr     = IsSame<nullptr_t, RemoveConstVolatile<T>>;
...
using Meta::AddConstToReference;
...
using Meta::MakeSigned;
using Meta::MakeUnsigned;
using Meta::IsConst;
using Meta::IsVolatile;
using Meta::IsSame;
using Meta::IsIntegral;
using Meta::IsFloatingPoint;
using Meta::IsArithmetic;
using Meta::IsClass;
using Meta::IsUnion;
using Meta::IsEnum;
using Meta::IsDerived;
using Meta::IsLValue;
using Meta::IsRValue;
using Meta::IsConcrete;
using Meta::IsTriviallyCopyable;
using Meta::IsSigned;
using Meta::IsUnsigned;
using Meta::IsVoid;
using Meta::IsNullPtr;
