...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_string_builder(StringBuilder&) -> FormatApplier;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> FormatApplier;
...
template<>
class Formatter<Cxx::nullptr_t> final : public FormatApplier {
public:
    /**
     * @brief Error safe factory functions
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<Cxx::nullptr_t>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<Cxx::nullptr_t>;
     ...
     */
    auto format(Cxx::nullptr_t) -> ErrorOr<void>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<StringView>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<StringView>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<T>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<T>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<bool>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<bool>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<char>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<char>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<f32>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<f32>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<f64>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<f64>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<f80>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<f80>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<char const*>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<char const*>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<SourceLocation>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<SourceLocation>;
...
template<>
class Formatter<ErrnoCode> final : public FormatApplier {
public:
    /**
     * @brief Error safe factory functions
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<ErrnoCode>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<ErrnoCode>;
     ...
     * @brief Performs the format on the given string-builder
     */
    auto format(ErrnoCode const&) const -> ErrorOr<void>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<Error>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<Error>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<String>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<String>;
...
public:
     ...
     */
    [[nodiscard]]
    static auto construct_from_format_applier(FormatApplier) -> Formatter<StringBuilder>;
    [[nodiscard]]
    static auto construct_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<StringBuilder>;
