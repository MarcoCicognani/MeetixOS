...
public:
     ...
     */
    [[nodiscard]]
    static auto new_from_format_applier(FormatApplier) -> Formatter<ErrnoCode>;
    [[nodiscard]]
    static auto new_from_parser_result(StringBuilder&, FormatParser::Result) -> Formatter<ErrnoCode>;
