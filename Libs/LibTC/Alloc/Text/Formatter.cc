...
auto Formatter<Cxx::nullptr_t>::construct_from_format_applier(FormatApplier format_applier) -> Formatter<Cxx::nullptr_t> {
    return Formatter<Cxx::nullptr_t>{ Cxx::move(format_applier) };
}

auto Formatter<Cxx::nullptr_t>::construct_from_parser_result(StringBuilder& string_builder, FormatParser::Result result) -> Formatter<Cxx::nullptr_t> {
    return construct_from_format_applier(FormatApplier::construct_from_parser_result(string_builder, Cxx::move(result)));
}

auto Formatter<Cxx::nullptr_t>::format(Cxx::nullptr_t) -> ErrorOr<void> {
...
Formatter<Cxx::nullptr_t>::Formatter(FormatApplier format_applier)
...
auto Formatter<T>::format(T value) -> ErrorOr<void> {
    if ( display_as() == FormatParser::DisplayAs::Char ) {
        ...
        try$(sv_formatter.format(StringView::construct_from_raw_parts(Cxx::bit_cast<char const*>(&value), 1)));
...
auto Formatter<char>::format(char value) const -> ErrorOr<void> {
    if ( display_as_is_numeric() ) {
        ...
        auto sv_formatter = Formatter<StringView>::construct_from_format_applier(clone_format_applier());
        try$(sv_formatter.format(StringView::construct_from_raw_parts(&value, 1)));
    }
...
#ifndef IN_KERNEL
auto Formatter<f32>::construct_from_format_applier(FormatApplier format_applier) -> Formatter<f32> {
    return Formatter<f32>{ Cxx::move(format_applier) };
}

auto Formatter<f32>::construct_from_parser_result(StringBuilder& string_builder, FormatParser::Result result) -> Formatter<f32> {
    return construct_from_format_applier(FormatApplier::construct_from_parser_result(string_builder, Cxx::move(result)));
}

auto Formatter<f32>::format(f32 value) const -> ErrorOr<void> {
    auto double_formatter = Formatter<f64>::construct_from_format_applier(clone_format_applier());
...
auto Formatter<f64>::construct_from_format_applier(FormatApplier format_applier) -> Formatter<f64> {
    return Formatter<f64>{ Cxx::move(format_applier) };
}

auto Formatter<f64>::construct_from_parser_result(StringBuilder& string_builder, FormatParser::Result result) -> Formatter<f64> {
    return construct_from_format_applier(FormatApplier::construct_from_parser_result(string_builder, Cxx::move(result)));
}
...
auto Formatter<f80>::construct_from_format_applier(FormatApplier format_applier) -> Formatter<f80> {
    return Formatter<f80>{ Cxx::move(format_applier) };
}

auto Formatter<f80>::construct_from_parser_result(StringBuilder& string_builder, FormatParser::Result result) -> Formatter<f80> {
    return construct_from_format_applier(FormatApplier::construct_from_parser_result(string_builder, Cxx::move(result)));
}
...
auto Formatter<char const*>::format(char const* value) const -> ErrorOr<void> {
    if ( display_as() == FormatParser::DisplayAs::Pointer ) {
        ...
        auto sv_formatter = Formatter<StringView>::construct_from_format_applier(clone_format_applier());
        try$(sv_formatter.format(StringView::construct_from_cstr(value)));
    }
