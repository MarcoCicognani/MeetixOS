...
public:
    ...
    [[nodiscard]] bool contains(const Point& p) const {
        return (p.x() >= m_x) && (p.y() >= m_y) && (p.x() < m_x + m_width)
            && (p.y() < m_y + m_height);
    }
    ...
    bool operator==(const Rectangle& rhs) const {
        return m_x == rhs.m_x && m_y == rhs.m_y && m_width == rhs.m_width
     ...
     */
    [[nodiscard]] i32 y() const {
        return m_y;
    }
    [[nodiscard]] i32 top() const {
        return m_y;
    }
    void set_top(i32 top) {
        m_y = top;
    }
     ...
     * @brief Get/Set for m_y
     */
    [[nodiscard]] i32 x() const {
        return m_x;
    }
    [[nodiscard]] i32 left() const {
        return m_x;
    }
    void set_left(i32 left) {
        m_x = left;
    }
     ...
     */
    [[nodiscard]] i32 bottom() const {
        return m_y + m_height;
    }
    void set_bottom(i32 bottom) {
        m_height = bottom - m_y;
    }
     ...
     */
    [[nodiscard]] i32 right() const {
        return m_x + m_width;
    }
    void set_right(i32 right) {
        m_width = right - m_x;
    }
