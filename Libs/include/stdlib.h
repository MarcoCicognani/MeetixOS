 ...
 *
 * @param str:		string to convert
 * @param endptr:	is set to the end of the numeric value in <str>
 * @return converted value
 */
 ...
 *
 * @return computed pseudo-random value
 */
int rand();
 ...
 * @param overwrite:	whether to overwrite ane existing variable
 ...
 * @return return code of the command processor
 */
 ...
 *
 * @param out_argc:		is filled with the number of arguments
 * @param out_args:		is assigned with the argument array
 ...
 *
 * @param numer:	value to divide
 * @param denom:	divisor to use
 * @return a value of type <div_t> containing the calculation result
 */
 ...
 *
 * @param s:		string containing the multibyte character
 * @param n:		number of bytes to search for the character
 * @return non-zero if multibyte character encodings have state-dependent encodings,
 * 		otherwise 0
 */
 ...
 * @return if successful, number of elements modified in the target array,
 * 		otherwise -1
 */
 ...
 * @return if successful, number of bytes modified in the target array,
 * 		otherwise -1
 */
 ...
 * POSIX.1-2001
 *
 * @param templ:	file name template to use
