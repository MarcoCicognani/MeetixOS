...
#ifndef MEETIX_LIBRARY_UI_FOCUSLISTENER
#define MEETIX_LIBRARY_UI_FOCUSLISTENER
...
public:
	...
	{
		UiComponentFocusEvent *event = (UiComponentFocusEvent*) header;
		handleFocusChanged(event->nowFocused);
	}
