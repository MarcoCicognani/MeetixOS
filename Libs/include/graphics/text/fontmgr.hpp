...
public:
	 ...
	 */
	bool createFont(const std::string &name, uint8_t *source, uint32_t sourceLength, FontStyle style = FontStyle::NORMAL, bool hint = true);
	 ...
	 */
	inline FT_Library getLibraryHandle() { return library; }
};
