...
public:
	...
	static void send(const std::string &title, const std::string &message, uint32_t sleep, Color_t color);
	 ...
	 */
	static void send(const std::string &title, const std::string &message, uint32_t sleep, Color_t color, MessageAnimation_t animation);
};
