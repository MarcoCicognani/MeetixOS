 ...
 *
 */
FsTransactionID FsDelegateMount::requestDiscovery(Thread*                        requester,
                                                  FsNode*                        parent,
                                                  char*                          child,
 ...
 *
 */
FsTransactionID FsDelegateMount::requestRead(Thread*                   requester,
                                             FsNode*                   node,
                                             int64_t                   length,
 ...
 *
 */
void FsDelegateMount::finishRead(Thread*                requester,
 ...
 *
 */
void FsDelegateMount::finishWrite(Thread*                requester,
 ...
 *
 */
FsTransactionID FsDelegateMount::requestGetLength(Thread*                        requester,
                                                  FsNode*                        node,
 ...
 */
FsTransactionID
FsDelegateMount::requestDirectoryRefresh(Thread*                               requester,
                                         FsNode*                               folder,
 ...
 *
 */
void FsDelegateMount::finishDirectoryRefresh(Thread*                               requester,
                                             FsTransactionHandlerDirectoryRefresh* handler) {
}
 ...
 *
 */
FsTransactionID FsDelegateMount::requestClose(Thread*                    requester,
