...
public:
    ...
    /**
     * Used to open a file. The given node can be two things here: If the node was found (meaning
     * the file already exists) it is the node itself. Otherwise it is the last discovered parent
     * node and the filename is the name of the file that shall be created.
     */
