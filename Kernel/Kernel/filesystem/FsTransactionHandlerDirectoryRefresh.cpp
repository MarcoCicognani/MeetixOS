...
FsTransactionHandlerDirectoryRefresh::startTransaction(Thread* thread) {
    // take the delegate
...
FsTransactionHandlerDirectoryRefresh::finishTransaction(Thread* thread, FsDelegate* delegate) {
    if ( delegate )
