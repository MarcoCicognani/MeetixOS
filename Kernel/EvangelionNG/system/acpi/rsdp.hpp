...
struct RsdpDescriptor {
    char signature[8]; // This 8-byte string (not null terminated!) must contain "RSD PTR ". It
                       // stands on a 16-byte boundary.
    uint8_t checksum;  // The value to add to all the other bytes (of the Version 1.0 table) to
                       // calculate the Checksum of the table.
