...
public:
	 ...
	 */
	static const char *adjustTaskIdentifier(Thread *target, Thread *firstExist, const char *preferredIdentifier);
	 ...
	 */
	static bool registerTaskForIdentifier(Thread *task, const char *newIdentifier, char *selectedIdentifier);
