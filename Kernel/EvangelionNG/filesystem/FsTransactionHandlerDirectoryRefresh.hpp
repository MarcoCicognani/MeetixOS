...
public:
	 ...
	 *
	 */
	FsTransactionHandlerDirectoryRefresh(FsNode *folder, Contextual<SyscallFsReadDirectory*> boundData, FsTransactionHandler *followupHandler) : folder(folder), data(boundData), unfinishedHandler(followupHandler) {}
	...
	{
		if (unfinishedHandler) delete unfinishedHandler;
	}
