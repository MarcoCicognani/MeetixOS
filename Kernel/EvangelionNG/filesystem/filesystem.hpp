...
public:
	...
	static bool nodeForDescriptor(Pid pid, File_t fd, FsNode **outNode, FileDescriptorContent **outFd);
	 ...
	 *
	 */
	static File_t clonefd(File_t sourceFd, Pid sourcePid, File_t targetFd, Pid targetPid, FsClonefdStatus *outStatus);
