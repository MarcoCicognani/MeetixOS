...
#ifndef EVA_SHARED_GDT_MOUNTER
#define EVA_SHARED_GDT_MOUNTER
 ...
 *
 * @param gdtPointerAddress:    pointer to the GDT to loads
 */
 ...
 *
 * @param tssDescriptorIndex:   pointer to the TSS to loads
 */
