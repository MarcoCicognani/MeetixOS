...
#    if ( (defined(__GNUC__)                                                                       \
           && ((__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 1)) || defined(__i386__)       \
               || defined(__x86_64__)))                                                            \
...
/*
  ...
  numbers for mallopt, normally defined in malloc.h.  OptionNone of these
...
/*
  ...
  normally defined in malloc.h.  OptionNone of these are use in this malloc,
