...
#    if defined(__unix) || defined(__unix__) || defined(unix) || defined(DUK_F_LINUX)              \
        || defined(DUK_F_BSD)
#        define DUK_F_UNIX
#    endif
...
#    if defined(__mips__) || defined(mips) || defined(_MIPS_ISA) || defined(_R3000)                \
        || defined(_R4000) || defined(_R5900) || defined(_MIPS_ISA_MIPS1)                          \
        || defined(_MIPS_ISA_MIPS2) || defined(_MIPS_ISA_MIPS3) || defined(_MIPS_ISA_MIPS4)        \
        || defined(__mips) || defined(__MIPS__)
#        define DUK_F_MIPS
#        if defined(__LP64__) || defined(_LP64) || defined(__mips64) || defined(__mips64__)        \
            || defined(__mips_n64)
#            define DUK_F_MIPS64
#        else
#            define DUK_F_MIPS32
...
/* SuperH */
#    if defined(__sh__) || defined(__sh1__) || defined(__SH1__) || defined(__sh2__)                \
        || defined(__SH2__) || defined(__sh3__) || defined(__SH3__) || defined(__sh4__)            \
        || defined(__SH4__) || defined(__sh5__) || defined(__SH5__)
#        define DUK_F_SUPERH
#    endif
 ...
 */
#    if defined(DUK_F_X86) || defined(DUK_F_X32) || defined(DUK_F_M68K) || defined(DUK_F_PPC32)    \
        || defined(DUK_F_BCC) || (defined(__WORDSIZE) && (__WORDSIZE == 32))                       \
        || ((defined(DUK_F_OLD_SOLARIS) || defined(DUK_F_AIX) || defined(DUK_F_HPUX))              \
            && defined(_ILP32))
...
#    if !(defined(FP_NAN) && defined(FP_INFINITE) && defined(FP_ZERO) && defined(FP_SUBNORMAL)     \
          && defined(FP_NORMAL))
 ...
 *  $ /opt/qnx650/host/linux/x86/usr/bin/i486-pc-nto-qnx6.5.0-gcc -dM -E - </dev/null | grep -ni
 * endian 67:#define __LITTLEENDIAN__ 1 $
 * /opt/qnx650/host/linux/x86/usr/bin/mips-unknown-nto-qnx6.5.0-gcc -dM -E - </dev/null | grep -ni
 * endian 81:#define __BIGENDIAN__ 1 $
 * /opt/qnx650/host/linux/x86/usr/bin/arm-unknown-nto-qnx6.5.0-gcc -dM -E - </dev/null | grep -ni
 * endian 70:#define __LITTLEENDIAN__ 1
 */
#    if !defined(DUK_USE_BYTEORDER)
