...
static void timerHandler()
{
	...
	switch (color)
	{
		case RED:    display->setColor(RGB(200, 0, 0), 0);   break;
		case GREEN:  display->setColor(RGB(0, 200, 0), 0);   break;
		case BLUE:   display->setColor(RGB(0, 0, 200), 0);   break;
		case YELLOW: display->setColor(RGB(200, 200, 0), 0); break;
	}
...
void initializeInterface()
{
	...
	// configure buttons
	buttons->configure("red", Rectangle(10, 10, 150, 30), "RED", RGB(200, 0, 0), RGB(255, 255, 255));
	buttons->configure("green", Rectangle(180, 10, 150, 30), "GREEN", RGB(0, 200, 0), RGB(255, 255, 255));
	buttons->configure("blue", Rectangle(10, 50, 150, 30), "BLUE", RGB(0, 0, 200), RGB(255, 255, 255));
	buttons->configure("yellow", Rectangle(180, 50, 150, 30), "YELLOW", RGB(200, 200, 0), RGB(255, 255, 255));
	buttons->configure("begin", Rectangle(350, 10, 50, 30), "Begin", RGB(126, 126, 126), RGB(255, 255, 255));
	buttons->configure("end", Rectangle(350, 50, 50, 30), "end", RGB(126, 126, 126), RGB(255, 255, 255));
...
bool checkSequence()
{
	...
	for (int i = 0; i < userseq.size(); i++)
		if (spawned[i] != userseq[i]) equal = false;
