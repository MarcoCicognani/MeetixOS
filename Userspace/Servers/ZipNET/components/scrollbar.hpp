...
public:
    Scrollbar_t(ScrollbarOrientation_t orientation)
        : orientation(orientation), modelPosition(0), modelVisibleArea(0), modelTotalArea(0),
          knobDrag(false), dragPressPosition(0), dragViewPosition(0), scrollHandler(0) {
    }
    ...
    virtual void setScrollHandler(ScrollHandler_t* handler) {
        scrollHandler = handler;
    }
    virtual ScrollHandler_t* gettScrollHandler() {
