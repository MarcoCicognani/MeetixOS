 ...
 *
 */
void Geoshape_t::addChild(Component_t *component) { panel.addChild(component); }
...
void Geoshape_t::paint() {
  ...
  cairo_rectangle(geoshapeSurface, 0, 0, geoshapeBounds.width,
                  geoshapeBounds.height);
 ...
 *
 */
void Geoshape_t::setTitle(std::string title) { label.setTitle(title); }

/**
 *
 */
std::string Geoshape_t::getTitle() { return label.getTitle(); }
 ...
 *
 */
void Geoshape_t::PngAnimation(std::string path, Point PNGstartAnimation,
                              Point PNGendAnimation, size_t sleep) {}
